# Context Pack — 2026-06-15 (v2)

Two parts, read in order. **Part 1 is the mineable craft; Part 2 is the decision-style.**

- **Part 1 — CORE PATTERNS**: the distinctive, reusable *moves*, each isolated from an
  academy explainer that does one thing cleanly. Three taught in full (subworkflows /
  custom-tools / loops); five more as one-page PATTERN cards (branching, logs, agents,
  knowledge-base, tables — full scene annotations live in examples/<slug>/annotated/).
- **Part 2 — DECISION-STYLE EXEMPLARS**: the four hype golds (market-desk, browser-agent,
  agent-economy, voice-agent), taught scene-by-scene — how the moves compose into a whole.

Read Part 1 for *what move to reach for*; Part 2 for *how to compose them with taste*.
...
───────────────────────── CORE PATTERN (full): subworkflows ─────────────────────────
<!-- subworkflows / PATTERN.md -->
...
───────────────────────── CORE PATTERN (full): custom-tools ─────────────────────────
<!-- custom-tools / PATTERN.md -->
...
───────────────────────── A-TIER PATTERN CARDS ─────────────────────────
(The distinctive move only; full scene-by-scene annotations in examples/<slug>/annotated/.)

<!-- PATTERN CARD: branching -->
...
═══════════════════════════════════════════════════════════════════════
# PART 2 — DECISION-STYLE EXEMPLARS
═══════════════════════════════════════════════════════════════════════
